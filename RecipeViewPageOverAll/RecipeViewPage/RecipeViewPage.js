...
var ingrediants ={
    ...
    "Mutton Biryani" : "Onions (sliced) || Oil (125 ml) || Tender Meat (1 kg) || Raw Papaya Skin (1/4 cup) || Green Chillies (4) || Ginger Garlic Paste (2 - 2 1/2 tbsp) || Salt (3 1/2 tsp) || Coriander Powder (2 tsp) || Roasted Cumin Powder (2 tsp) || Mirchi (3 tbsp) || Turmeric (1/4 tsp) || Garam Masala (1 tbsp + 1/4 tsp) || Black Cumin (1 tsp + 1 tbsp) || Cloves (6 - 7 + 10 - 12) || Cinnamon (2 inches + 4 inches) || Biryani Leaves (2 + 3) || Cardamoms (5 + 5) || Kapok Seeds (2, broken) || Fried Onions (half + remaining) || Lemon Juice (1 + 1) || Ghee (1.5 tbsp + 80 ml) || Curd (250 ml) || Saffron Milk (1 tbsp + 1/4 cup) || Mint (small bunch + a little) || Green Coriander (small bunch + a little) || Flour Paste || Water (125 ml used for mixing with meat + 4 tbsp for dum) || Basmati Rice (1/2 kg, soaked for an hour) || Patthar Phool || Mace || Star Anise || Salt (3 - 4 tbsp for cooking rice)",
    "Avakai Chicken Biryani" :"Chicken (1 kg) || Rice (Basmati, 1/2 kg, soaked for an hour) || Oil (1/4 cup) || Onions (sliced, 2 large) || Ginger Garlic Paste (2 tbsp) || Green Chillies (3-4, slit) || Tomatoes (2, chopped) || Avakai Pickle (1/2 cup) || Yogurt (1/2 cup) || Red Chilli Powder (1 tbsp) || Turmeric Powder (1/2 tsp) || Coriander Powder (1 tbsp) || Cumin Powder (1 tsp) || Garam Masala (1 tsp) || Cinnamon Stick (1 inch) || Cloves (4-5) || Cardamom Pods (3-4) || Bay Leaves (2) || Mint Leaves (a handful, chopped) || Coriander Leaves (a handful, chopped) || Lemon Juice (2 tbsp) || Salt (to taste) || Water (3 cups, for cooking rice) || Ghee (2 tbsp, optional) || Fried Onions (1/4 cup, for garnish) || Saffron (a pinch, soaked in 2 tbsp warm milk, optional)",
    "Pot Biryani" :"Chicken (1 kg) || Basmati Rice (1/2 kg, soaked for an hour) || Oil (1/4 cup + for frying onions) || Onions (sliced, 2 large) || Ginger Garlic Paste (2 tbsp) || Green Chillies (3-4, slit) || Tomatoes (2, chopped) || Avakai Pickle (1/2 cup) || Yogurt (1/2 cup) || Red Chilli Powder (1 tbsp) || Turmeric Powder (1/2 tsp) || Coriander Powder (1 tbsp) || Cumin Powder (1 tsp) || Garam Masala (1 tsp + for sprinkling) || Cinnamon Stick (1 inch + for boiling rice) || Cloves (4-5 + for boiling rice) || Cardamom Pods (3-4 + for boiling rice) || Bay Leaves (2 + for boiling rice) || Mint Leaves (a handful, chopped + for boiling rice) || Coriander Leaves (a handful, chopped + for boiling rice) || Lemon Juice (2 tbsp) || Salt (to taste + for boiling rice) || Water (3 cups, for cooking rice) || Ghee (2 tbsp, optional) || Fried Onions (1/4 cup, for garnish) || Saffron (a pinch, soaked in 2 tbsp warm milk, optional) || Maida Flour Paste (for sealing the pot)",
    "Chicken Keema" :"Chicken Keema (minced chicken, 500g) || Oil (3 tbsp) || Onions (finely chopped, 2 medium) || Tomatoes (finely chopped, 2 medium) || Ginger Garlic Paste (2 tbsp) || Green Chillies (2-3, finely chopped) || Red Chilli Powder (1 tsp) || Turmeric Powder (1/2 tsp) || Coriander Powder (1 tsp) || Cumin Powder (1/2 tsp) || Garam Masala (1/2 tsp) || Cinnamon Stick (1 inch) || Cloves (3-4) || Cardamom Pods (2-3) || Bay Leaf (1) || Green Peas (optional, 1/2 cup) || Yogurt (1/4 cup, beaten) || Salt (to taste) || Water (as needed) || Lemon Juice (1 tbsp) || Fresh Coriander Leaves (for garnish)",
    ...
    "Classic Cheese Burger":"Ground Beef (500g, 80% lean) || Salt (1 tsp) || Black Pepper (1/2 tsp) || Garlic Powder (1/2 tsp, optional) || Onion Powder (1/2 tsp, optional) || Cheese Slices (4, American or Cheddar) || Olive Oil (1 tbsp, for cooking) || Burger Buns (4) || Lettuce Leaves (4) || Tomato Slices (4) || Pickles (4-8 slices) || Onion Slices (4-8 slices, optional) || Mayonnaise (4 tbsp) || Ketchup (4 tbsp) || Mustard (optional, 4 tbsp)",
    ...
    "Margherita Pizza": "Pizza Dough (1 ball) || Tomato Sauce (1/2 cup) || Fresh Mozzarella (200g, sliced) || Fresh Basil Leaves (a handful) || Olive Oil (2 tbsp) || Salt (to taste) || Black Pepper (to taste)",
    // "Mutton Curry": "",
    "BBQ Chicken Pizza": "Pizza Dough (1 ball) || BBQ Sauce (1/2 cup) || Shredded Mozzarella Cheese (200g) || Cooked Chicken Breast (1 cup, shredded) || Red Onion (1/2, thinly sliced) || Cilantro (1/4 cup, chopped) || Olive Oil (2 tbsp)",
    // "Mutton Curry": "",
...
//      gifs[obj.name]=e;
//      procedure[obj.name]=f;
//      ingrediants[obj.name]=g;
//      images[obj.name]=obj['imageURL'];
...
Object.keys(sessionStorage).map((ele) =>{
    // console.log(ele)
    if(ele !== "IsThisFirstTime_Log_From_LiveServer"){
        call(ele)
        console.log(ele)
    }
    // console.log(ele)
